<h3><?php _e( 'Poppy Payments', 'woocommerce-payment-gateway-boilerplate' ); ?></h3>
...
<div class="gateway-banner updated">
  ...
  <p><a href="https://www.gateway-domain.com" target="_blank" class="button button-primary"><?php _e( 'Sign up for Poppy Payments', 'woocommerce-payment-gateway-boilerplate' ); ?></a> <a href="https://www.gateway-domaim.com" target="_blank" class="button"><?php _e( 'Learn more', 'woocommerce-payment-gateway-boilerplate' ); ?></a></p>
  <?php } ?>
</div>
