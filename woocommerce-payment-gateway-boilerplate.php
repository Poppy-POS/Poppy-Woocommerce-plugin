<?php
/*
 * Plugin Name: Poppy Payment Gateway
 * Plugin URI: https://poppypos.com
 * Description: Crypto payments with poppy.
 * Author: POPPY
 * Author URI: https://poppypos.com
 * Version: 1.0.1
 *
...
if( !class_exists( 'WC_Gateway_Name' ) ) {
  ...
  /**
   * WooCommerce {%Poppy Payments%} main class.
   *
   * @TODO    Replace 'Gateway_Name' with the name of your payment gateway class.
   * @class   Gateway_Name
   * @version 1.0.0
  ...
  final class WC_Gateway_Name {
     ...
     * @return array WooCommerce {%Poppy Payments%} gateway.
     */
 ...
 *
 * @return WooCommerce Poppy Payments
 */
